...
void FN_LargeParConv_5x5_S2_Max2x2_S2_H_1(
		short int * __restrict__ In,
		short int * __restrict__ Filter,
		short int * __restrict__ Out,
		unsigned int Norm,
...
void FN_MedParConv_3x3_S2_ReLU_2(
		short int * __restrict__ In,
		short int * __restrict__ Filter,
		short int * __restrict__ Out,
		unsigned int Norm,
...
void FN_MedParConv_3x3_S2_ReLU_5(
		short int * __restrict__ In,
		short int * __restrict__ Filter,
		short int * __restrict__ Out,
		unsigned int Norm,
...

{
	...
	rt_dma_memcpy((rt_pointerT) Filter+(0), (rt_pointerT) (PULP_Dronet_L1_Memory + 0)+0, 18432, RT_DMA_DIR_EXT2LOC, 0, &DmaR_Evt2);
	rt_dma_memcpy((rt_pointerT) Filter+(18432), (rt_pointerT) (PULP_Dronet_L1_Memory + 18432)+0, 18432, RT_DMA_DIR_EXT2LOC, 0, &DmaR_Evt3);
	rt_dma_memcpy((rt_pointerT) Bias+(0), (rt_pointerT) (PULP_Dronet_L1_Memory + 36864)+0, 128, RT_DMA_DIR_EXT2LOC, 0, &DmaR_Evt4);
	/* Wait for BUFF read in L2 */

	// DANIELE'S DEBUG -- DO NOT TOUCH IT
	// unsigned int checksumF = 0;
	// unsigned int checksumF2 = 0;
	// short unsigned int *ptrF = (short unsigned int *) PULP_Dronet_L1_Memory;
	// short unsigned int *ptrF2 = (short unsigned int *) Filter;
	// for(int i=0; i<36864/2; i++){
	// 	checksumF += (unsigned int) ptrF[i];
	// 	checksumF2 += (unsigned int) ptrF2[i];
	// 	// ptrF[i] = ptrF2[i];
	// }
	// printf("CHECKS after DMA %d %d\n",checksumF,checksumF2);
...
void FN_MedParConv_3x3_S2_ReLU_8(
		short int * __restrict__ In,
		short int * __restrict__ Filter,
		short int * __restrict__ Out,
		unsigned int Norm,
...
void FN_MedParConv_1x1_S1_ReLU_10(
		short int * __restrict__ In,
		short int * __restrict__ Filter,
		short int * __restrict__ Out,
		unsigned int Norm,
...
void FN_AddFeatureMapsReLu_SW_3(
		short int * __restrict__ In,
		short int * __restrict__ Out,
		Kernel_T *Ker)
